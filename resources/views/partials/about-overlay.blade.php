<div id="about-overlay" class="about-overlay" role="dialog" aria-modal="true" aria-label="About Integrax Berhad" hidden>
    ...
    <a href="/" class="about-home js-about-close" aria-label="Go to homepage">
    ...
    <a href="/leadership" class="about-node" data-node="leadership" aria-label="Leadership">
        <span class="about-node-icon" aria-hidden="true">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="/achievement" class="about-node" data-node="achievement" aria-label="Achievement">
        <span class="about-node-icon" aria-hidden="true">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="/governance" class="about-node" data-node="governance" aria-label="Governance">
        <span class="about-node-icon" aria-hidden="true">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
