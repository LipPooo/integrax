                ...
                <div class="grid gap-12 sm:grid-cols-2 lg:col-span-4 lg:col-start-8">
                    ...
                    <div>
                        ...
                        <div class="mt-8 flex gap-4">
                            ...
                            <a href="#" class="flex h-11 w-11 items-center justify-center rounded-full border border-white/12 text-white/65 transition hover:border-integrax-blue-light hover:text-white" aria-label="Email">
